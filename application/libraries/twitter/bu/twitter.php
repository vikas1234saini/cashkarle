<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
 ...
 include APPPATH.'libraries/twitter/OAuth.php';
...
class Twitter
{
	...
	public function __construct($auth=array())
	{
		...
		$this->consumer = new OAuthConsumer($auth['consumerKey'], $auth['consumerSecret']);
		$this->token = new OAuthConsumer($auth['accessToken'], $auth['accessTokenSecret']);
	}
