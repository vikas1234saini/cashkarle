    ...
    */
	 ...
	 public function index()
    {
		...
		if($search_string !== false || $order !== false || $page != ''){ 
            ...
            $data['count_contact']= $this->contact_model->count_contact($search_string, $order,null);
            $config['total_rows'] = $data['count_contact'];
            $data['contact'] = $this->contact_model->get_contact($search_string, $order, $order_type, $config['per_page'],$limit_end);        
            ...
            $data['contact'] 			= $this->contact_model->get_contact('', '', $order_type, $config['per_page'],$limit_end);        
            $config['total_rows'] 	= $data['count_contact'];
