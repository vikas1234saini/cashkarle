...
footer p { text-align:justify;}
            ...
            <div class="top-footer" style="margin-top:20px;padding-bottom:20px;border-bottom:1px solid #dbdbdb;overflow:hidden;">
                ...
                <div class="col-md-5">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control cfc" placeholder="Username" aria-describedby="basic-addon1">
                        <span class="input-group-addon cao" id="basic-addon1">SUBMIT</span>
                    </div>
                </div>
                <div class="col-md-3">
                    <h3 style="margin-top:0">Follow us on</h3>
                    <div>
                    <i class="fa fa-facebook" style="margin:10px;"></i>
                    <i class="fa fa-twitter" style="margin:10px;"></i>
                    <i class="fa fa-linkedin" style="margin:10px;"></i>
                    <i class="fa fa-google-plus" style="margin:10px;"></i>
                    </div>
			...
			<div class="container">
                <div class="row">
                    ...
                    <div class="col-md-4 col-md-offset-4" id="login">
                        <div class="sign-up-form" style="margin-top:20px;">
                            <div class="form text-center ">
                                ...
                                <form action="" method="post" id="frmLogin" name="frmLogin">
                                    ...
                                    <h2 class="text-left green" style="margin-top:0;">Sign In</h2>
                                    <p class="fw-300 text-left" style="font-size:14px;color:#4e4e4d">Sign in to your account to avail Special Offers and cashback</p>
                                    <div id="fblogin">
	                                    ...
	                                    <div style="margin:10px;"><center><script type="in/Login"></script></center></div>
                                    ...
                                    <input class="form-control cfc" placeholder="Email" name="login_email" id="login_email" type="text">
                                    <input class="form-control cfc" placeholder="Password" name="login_password" id="login_password" type="password">
						            ...
						            <button type="submit" class="btn btn-warning btn-round" style="width:80%;height:40px;font-size:16px;" id="login_btn">Sign In</button><br>
                                    <div class="wihtoutlogin" style="display:none;">
						            <a href="#" class="wihtoutlogina" target="_blank"><button type="button" class="btn btn-warning btn-round" style="width:100%; margin-top:20px;height:40px;font-size:16px;">CONTINUE WITHOUT CASHBACK</button></a>
                                    </div>
                                    <div class="singuplink">
                                        <p class="ft-11" style="margin-bottom:0;margin-top:20px;">Forgot Passowrd <a class="forgot-password-btn"> Click Here</a></p>
                                        <p  class="ft-11" style="margin-bottom:0;margin-top:5px;">Dont have an Account?<a class="sign-up-btn"> Sign Up Now </a></p>
                                    </div>
                                </form>
                            </div>
	...
	function isNumber(evt) {
		...
		$(document).ready(function() {
			$('#skey').blur(function(){
				$('#frmsearch').attr('action',"<?php echo base_url('search'); ?>/"+$('#skey').val().replace(/ /gi,"-"));					   
            });
        ...
        $(document).ready(function() {
	        ...
	        $('#amount').blur(function(){
				...
				if(newval<0){
					...
					$('#errormessage_text').html("<span style='color:green;'><strong>Amount must be less than earning amount.</strong></span>");
