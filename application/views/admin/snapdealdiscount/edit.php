    <div class="container top">
      ...
      if($this->session->flashdata('flash_message')){
        if($this->session->flashdata('flash_message') == 'updated')
        {
          echo '<div class="alert alert-success">';
            ...
            echo '<strong>Well done!</strong> snapdealdiscount updated with success.';
          echo '</div>';       
        }else{
     ...
     /* $options_manufacture = array('' => "Select");
      ...
      echo form_open('admin/snapdealdiscount/update/'.$this->uri->segment(4).'', $attributes);
      ?>
      <fieldset>
          ...
          <div class="control-group">
            ...
            <div class="controls">
              <input type="text" id="category" name="category" value="<?php echo $snapdealdiscount[0]['category']; ?>" >
            </div>
          </div>
          <div class="control-group">
