 <script type='text/javascript'>
    ...
    <div class="container top">
      ...
      if($this->session->flashdata('flash_message')){
        if($this->session->flashdata('flash_message') == 'viewd')
        {
          echo '<div class="alert alert-success">';
            ...
            echo '<strong>Well done!</strong> contact viewd with success.';
          echo '</div>';       
        }else{
     ...
     /* $options_manufacture = array('' => "Select");
      ...
      echo form_open('admin/contact/view/'.$this->uri->segment(4).'', $attributes);
      ?>
      <fieldset>
          ...
          <div class="control-group">
            ...
            <div class="controls">
             	<?php echo date("d-m-Y",strtotime($contact[0]['date'])); ?>
            </div>
          </div>
          <div class="control-group">
