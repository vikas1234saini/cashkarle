     ...
     /* $options_manufacture = array('' => "Select");
      ...
      <fieldset>
          ...
          <div class="control-group">
            ...
            <div class="controls">
              <input type="text" id="title" name="title" value="<?php echo $order[0]['title']; ?>" >
            </div>
          </div>
          <div class="control-group">
            <label for="inputError" class="control-label">Image Url</label>
            <div class="controls">
              <input type="text" id="image" name="image" value="<?php echo $order[0]['image']; ?>" >
              <br />
              <img width="100px" src="<?php echo $order[0]['image']; ?>" />
            </div>
          </div>
          <div class="control-group">
            <label for="inputError" class="control-label">Site Link</label>
            <div class="controls">
              <input type="text" id="url" name="url" value="<?php echo $order[0]['url']; ?>" >
            </div>
          </div>
          <div class="control-group">
            <label for="inputError" class="control-label">Discount(%)</label>
            <div class="controls">
              <input type="text" id="discount" name="discount" value="<?php echo $order[0]['discount']; ?>" >
            </div>
          </div>
